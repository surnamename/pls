/**
 * @ngdoc directive
 * @name app.directive:collapseSidebar
 * @description
 * # collapseSidebar
 */
angular.module('app').directive('collapseSidebar', ['$timeout',
  function ($timeout) {
    'use strict';
    return {
      restrict: 'A',
      link: function postLink(scope, element) {
        ...
        element.on('click', function (e) {
          if (app.hasClass('sidebar-sm')) app.removeClass('sidebar-sm').addClass('sidebar-xs');
          else if (app.hasClass('sidebar-xs')) app.removeClass('sidebar-xs');
          else app.addClass('sidebar-sm');
